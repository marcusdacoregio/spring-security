	...
	void apply(Project project) {
		...
		project.plugins.withType(JavaPlugin) {
			...
			if (checkstyleDir.exists() && checkstyleDir.directory) {
				...
				project.dependencies.add('checkstyle', versionCatalog.findLibrary('spring-javaformat-checkstyle').get())
				project.dependencies.add('checkstyle', versionCatalog.findLibrary('nohttp-checkstyle').get())
