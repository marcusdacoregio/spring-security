...
In some scenarios, you may want to apply the filter to every request, one common example is securing the https://docs.spring.io/spring-boot/docs/current/reference/htmlsingle/#web.servlet.spring-mvc.error-handling[`/error` page from Spring Boot].
